...
END
GO
PRINT N'Création de [dbo].[DeleteReservation]...';
...
AS
	...
	END
GO
PRINT N'Création de [dbo].[UpdatePushNotificationsToken]...';


GO
CREATE PROCEDURE [dbo].[UpdatePushNotificationsToken]
	@param1 int = 0,
	@param2 int
AS
...
*/
insert into [User]
values('O tacos','otac@otac.be','hello','Ne laissez plus vos tacos sans sauce','Chaussee de diannt',4,'namet',4564,0458646,
'https://o-tacos.com/soundboard/static/media/logo.0e4ccc18.png',50.46825401694036, 4.861805540581263,3.5);
insert into [User]
values('Bonbon','bonbon@bonbon.be','hello','Un bon gastronomique sur bruxelles et ses alentours','place des panier',355,'FEDXCEX',4564,0458646,
'https://www.restaurant-bon-bon.be/images/2019/103-Bon-Bon-30-10-2018-1024x682.jpg',50.82328171058906, 4.446769922726022,5);
insert into [User]
values('Quick','quick@quick.be','hello','Découvrez notre Giant','Chaussée de bouge',7,'thon',4567,075648646,
...
insert into [User]
values('Pizza Hut','pizza@pizza.be','hello','Mardi malin chez pizza hut','rue des lapins re',45,'name',1346,04586435,
...
insert into [User]
values('Sushi Shop','suhsi@sushi.be','hello','prenez une pause sushi','place des panier',355,'FEDXCEX',4564,0458646,
