...
AS
BEGIN
        INSERT INTO [User]([Name],Email,[PassWord],[Description],[AdressStreet],[AdressNum],[AdressCity],[AdresseZip],[PhoneNum],[Logo],[Latitude],[Longitude])
		VALUES (@Name,@Email,HASHBYTES('SHA2_512', dbo.GetPreHash() + @Password + dbo.GetPostHash()),@Description,@AdressStreet,@AdressNum,@AdressCity,@AdresseZip,@PhoneNum,@Logo,@Latitude,@longitude)
END
GO
